...
soundfiles = dir('H:\Oddball\stimuli\sounds\Top60_familiarity\*.wav');
freqaudio = 22050;                                                          
pahandle = PsychPortAudio('Open', 1, 1, 4, freqaudio);                      % Die erste 1 mit einer 9 ersetzen!!!!! PsychPortAudio('Open' [, deviceid][, mode (1= sound playback only)][, reqlatencyclass]
...
% .txt file - data
if switch_txtdatei
    fid = fopen(['H:\Oddball\soundsequence\soundsequence' Subject '.txt'],'wt');
...
%         Novelty
        elseif orderTrial(n) == 3
            ...
            [audiodata] = audioread(['H:\GitHub\MazeVR\Assets\My_Sounds\stimuli\sounds' presentfile]);                          
